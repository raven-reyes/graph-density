...
//graph density formular for a  directed graph is DEN(DIRECTED) =  |E| 
                                                             // -------------
                                                            //   (|V|*|V|-1)
// for a complete directed or undirected graph, the density is always 1 because for complete graphs
// each vertex V is connected to every other vertex V-1
